...
<RevealOnScroll>
        <div className="text-center z-10 px-4">
            ...
            className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">
                Hi, I'm Tinotenda Victor Tarirai
            </h1>

            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                I'm a full stack web developer who loves developing clean,
                scalable web applications. My goal is to develop solutions
                that are high perfomative and offer great experience.
            </p>
